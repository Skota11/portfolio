...
<link href="https://fonts.googleapis.com/css2?family=Barlow:wght@400;700&display=swap" rel="stylesheet" />
      ...
      <main>
        <animated.div style={{
          ...
          <div className='flex place-content-center'>
            <div className='rounded-xl bg-sprout w-11/12 max-w-screen-md p-8 shadow-lg duration-300 hover:shadow-2xl'>
              ...
              <div>
                <p>プログラミングと音楽好きの高校生</p>
                <p>Webアプリ開発やマイクラ鯖主とかやってます。</p>
              </div>
              <hr className='my-4' />
              ...
              <p className='mt-2'><FontAwesomeIcon width="30px" className='inline mr-2' icon={faRaspberryPi} />RaspberryPi 4 (自宅鯖)</p>
            </div>
          </div>
        </animated.div>
        <animated.div id="link" style={{
          ...
          <div className='flex place-content-center'>
            <div className='rounded-xl bg-vanilla w-11/12 max-w-screen-md p-8 shadow-lg duration-300 hover:shadow-2xl'>
        ...
        <animated.div id="contact" style={{
          ...
          <div className='flex place-content-center'>
            <div className='rounded-xl bg-cold_purple w-11/12 max-w-screen-md p-8 shadow-lg duration-300 hover:shadow-2xl'>
        ...
        <animated.div id="status" style={{
          ...
          <div className='flex place-content-center'>
            <div className='rounded-xl bg-spring_wood w-11/12 max-w-screen-md p-8 shadow-lg duration-300 hover:shadow-2xl'>
              {status(activities)}
              <hr className='my-2' />
...
//api
const getAc = async () => {
  const ac = await (await fetch("https://my-activity-discord.onrender.com/activity/896299292845817856/")).json();
  console.log(ac);
  return ac
};
