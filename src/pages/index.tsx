    ...
    <>
      ...
      <main>
        ...
        <animated.div id="link" style={{
          ...
          <div className='flex place-content-center'>
            <div className='rounded-xl bg-vanilla w-4/5 max-w-screen-md p-8 shadow-lg duration-300 hover:shadow-neutral-300'>
        ...
        <animated.div id="contact" style={{
          ...
          <div className='flex place-content-center'>
            <div className='rounded-xl bg-cold_purple w-4/5 max-w-screen-md p-8 shadow-lg duration-300 hover:shadow-neutral-300'>
